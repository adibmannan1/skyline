...
const Home = () => {
  ...
  return (
    <>
      <div className="mt-5 md:mt-0 max-sm:h-full hero w-full lg:w-[95%] xl:w-[90%] mx-auto dark:bg-black bg-transparent  dark:bg-dot-white/[0.2] bg-dot-black/[0.2] relative flex items-center justify-center">
