    ...
    <nav className="flex justify-between items-center h-[70px] font-bold">
        ...
        <div className={`menu absolute top-0 z-20 bg-[#0d263bd2] w-full text-[#F4F9FF] h-screen sm:hidden ${active ? "right-0" : "right-[-100%]"} custom-transition backdrop-blur-lg`}>
            ...
            <div className="w-[90%] mx-auto flex gap-5 items-center mt-5">
                <a href="/" className="logo items-center gap-3 flex mr-2">
            ...
            <div className="links flex flex-col gap-5 mt-10">
                {
                    links.map(link => <a href={link.link} key={link.name} className="bg-[#dcecff] w-[90%] mx-auto py-2 px-4 rounded text-[#0d263b] flex gap-3 items-center">
